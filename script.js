...
ctx.font = "bold 200px Arial"; // Clear, bold text
ctx.fillText("End", cnvs.width * 0.5, cnvs.height * 0.5);
var texMessage = new THREE.CanvasTexture(cnvs);
/////////////////////////////////////////////////////////////////
...
` + shader.vertexShader;
  ...
  shader.vertexShader = shader.vertexShader.replace(
    ...
    vec3 efcClamp = vec3(1.0, 0.5, 0.25) * 3.5; // Original depth
...
// Small particles (Multiplier 2.0)
gl_PointSize = mix(gl_PointSize, size * 2.0, vIsEffect);
    `
  );
